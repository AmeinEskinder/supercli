...
# command line exposes them in `ps` output. unpeel-load reads
# UNPEEL_MCP_TOKEN and UNPEEL_MOBILE_TOKEN from the environment.
UNPEEL_MCP_TOKEN="$MCP_TOKEN" UNPEEL_MOBILE_TOKEN="$MOBILE_TOKEN" \
"$LOAD" \
    --hook-port "$HOOK_PORT" \
