...
pub struct Palette {
    ...
    pub grok_accent: Color,
    pub muse_accent: Color,
    pub track: Color,
...
impl Palette {
    ...
    pub const ADAPTIVE: Self = Self {
        ...
        grok_accent: Color::Magenta,
        muse_accent: Color::Blue,
    ...
    pub const DARK: Self = Self {
        ...
        grok_accent: Color::Rgb(167, 139, 250),
        muse_accent: Color::Rgb(96, 165, 250),
    ...
    pub const LIGHT: Self = Self {
        ...
        grok_accent: Color::Rgb(108, 76, 172),
        muse_accent: Color::Rgb(45, 103, 196),
