...
void main() {
  group('HelpLinks', () {
    test('canonical URLs use the supercli.com contract', () {
      expect(HelpLinks.docs.url, 'https://supercli.com/docs');
      expect(HelpLinks.downloadMac.url, 'https://supercli.com/download/mac');
      expect(HelpLinks.downloadIos.url, 'https://supercli.com/download/ios');
      expect(HelpLinks.installCli.url, 'https://supercli.com/install.sh');
    });
    ...
    test('urlForButtonId maps view buttons back to URLs', () {
      expect(
        ...
        'https://supercli.com/docs',
      );
      expect(
        HelpLinks.urlForButtonId('help-link-download-mac'),
        'https://supercli.com/download/mac',
      );
