...
private func nativeRelayRequestCallback(
    ...
    guard let opaqueContext,
        ...
        return Int32(SUPERCLI_NATIVE_BRIDGE_RELAY_NOT_SENT)
    }
    ...
    do {
        ...
        return relayReturnError(
            Int32(SUPERCLI_NATIVE_BRIDGE_RELAY_NOT_SENT),
    ...
    let result = resultBox.take()
        ...
        return relayReturnError(
            Int32(SUPERCLI_NATIVE_BRIDGE_RELAY_TIMED_OUT_OUTCOME_UNKNOWN),
    ...
    case let .success(transport):
        ...
        do {
            ...
            return relayReturnError(
                Int32(SUPERCLI_NATIVE_BRIDGE_RELAY_OUTCOME_UNKNOWN),
        ...
        return Int32(SUPERCLI_NATIVE_BRIDGE_RELAY_OK)
    case let .failure(error as RemoteRelayConnectionError):
        switch error {
        case .generationChanged:
            return relayReturnError(
                Int32(SUPERCLI_NATIVE_BRIDGE_RELAY_GENERATION_CHANGED),
        ...
        case let .transport(delivery, message):
            let code = delivery == .notSent
                ? SUPERCLI_NATIVE_BRIDGE_RELAY_NOT_SENT
                : SUPERCLI_NATIVE_BRIDGE_RELAY_OUTCOME_UNKNOWN
            return relayReturnError(
                Int32(code),
                message: message,
                outPointer: outPointer,
        ...
        case let .timedOut(delivery):
            let code = delivery == .notSent
                ? SUPERCLI_NATIVE_BRIDGE_RELAY_TIMED_OUT_NOT_SENT
                : SUPERCLI_NATIVE_BRIDGE_RELAY_TIMED_OUT_OUTCOME_UNKNOWN
            return relayReturnError(
                Int32(code),
                message: error.localizedDescription,
                outPointer: outPointer,
...
enum NativeRelayBridge {
    ...
    static func open(
        ...
        deviceID: String,
        authToken: String
    ) throws -> supercli_native_bridge_remote_handle_t {
        ...
        let result = bearer.withUnsafeBytes { bearerBytes in
            supercli_native_bridge_remote_relay_open(
        ...
        guard result == SUPERCLI_NATIVE_BRIDGE_OK, openedHandle != 0 else {
            throw NativeRemoteBackend.bridgeFailure(
                ...
                fallbackMessage: "Could not open Supercli Link."
            )
        }
        return openedHandle
    }
