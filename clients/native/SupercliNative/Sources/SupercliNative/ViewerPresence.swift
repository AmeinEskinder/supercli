...
//
//  - File feed: the Rust remote server (crates/supercli-core/src/remote_server.rs)
//    writes `~/.supercli/remote/presence.json` whenever remote viewers change:
...
final class ViewerPresenceStore: ObservableObject {
    ...
    init(presenceURL: URL = LaunchConfig.supercliDir
