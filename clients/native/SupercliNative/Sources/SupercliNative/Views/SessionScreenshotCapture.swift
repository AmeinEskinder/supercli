...
//  screen-recording grant attributes to Supercli.app. Shots land in the session's `artifacts/uploads/` — the same
...
extension Notification.Name {
    ...
    static let supercliTakeSessionScreenshot = Notification.Name(
...
enum SessionScreenshotCapture {
    ...
    private static func run(
        ...
        do {
            ...
            NSLog("[SupercliNative] screencapture launch failed: \(error)")
            completion(nil)
        }
    }
}
