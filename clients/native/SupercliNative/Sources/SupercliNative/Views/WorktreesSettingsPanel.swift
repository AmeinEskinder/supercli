...
struct WorktreesSettingsPanel: View {
    ...
    /// discovery runs in this instance's SupercliStore, not on a remote Host.
        ...
        Section {
            ...
            SettingsSectionHeader(
                ...
                description: "Whether sessions may prepare worktrees through "
                    + "Supercli MCP. They still cannot launch sessions themselves."
            )
        }
    }
        ...
        store.displayProjectsByID.values
            .filter {
                $0.parentProjectID == nil
                    ...
                    && SupercliStore.isGitRepo(path: $0.path)
            }
            .sorted {
