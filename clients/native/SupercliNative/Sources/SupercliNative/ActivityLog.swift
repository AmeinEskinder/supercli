...
/// Append-only JSONL log at `<SUPERCLI_HOME>/activity-log.jsonl` (same
...
final class ActivityLogStore {
    ...
    func append(_ entry: ActivityLogEntry) {
        ...
        do {
            ...
            NSLog("[SupercliNative] failed to append activity-log: \(error)")
        }
    }
    ...
    private func compact() {
        ...
        do {
            ...
            NSLog("[SupercliNative] failed to compact activity-log: \(error)")
        }
    }
