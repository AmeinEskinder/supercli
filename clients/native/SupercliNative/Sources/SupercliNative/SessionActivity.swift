...
final class SessionActivityEngine {
    ...
    ///
    /// An installed Supercli App (`hasActiveApp`) is hook-capable by
...
/// so this file survives an app restart and lets SupercliStore re-seed the
...
struct LastHookEvent {
    ...
    static func runtimeGeneration(from json: [String: Any]) -> UInt64? {
        for key in ["supercli_runtime_generation", "supercliRuntimeGeneration"] {
