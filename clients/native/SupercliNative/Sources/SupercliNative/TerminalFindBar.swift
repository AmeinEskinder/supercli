...
extension Notification.Name {
    static let supercliTerminalFind = Notification.Name("supercli.terminal.find")
    static let supercliTerminalFindNext = Notification.Name("supercli.terminal.find-next")
    static let supercliTerminalFindPrevious = Notification.Name("supercli.terminal.find-previous")
}
