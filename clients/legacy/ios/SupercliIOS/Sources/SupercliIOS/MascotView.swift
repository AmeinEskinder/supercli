...
/// The Supercli pixel mascot — the little creature idling in the website
...
/// `supercli-mascot/mascot-animated.webp` at native pixel resolution) and
...
/// palette as the source art in `supercli-mascot/mascot-logo.svg` (the
...
private struct MascotFrame: View {
    ...
    /// `supercli-mascot/mascot-logo.svg`: the body sweeps through the site's
