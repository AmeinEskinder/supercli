...
final class AppLockManager {
    ...
    private static let enabledKey = "supercli.ios.appLockEnabled"
    ...
    func enable() async -> Bool {
        ...
        let ok = await authenticate(reason: "Confirm \(Self.methodLabel()) to lock Supercli when you leave the app")
    ...
    func unlock() async {
        ...
        if await authenticate(reason: "Unlock Supercli") {
            isLocked = false
        }
    }
