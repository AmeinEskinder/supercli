...
final class PairedMacStorageTests: XCTestCase {
    ...
    private let legacyRecordKey = "supercli.ios.pairedMac"
    private let recordsKey = "supercli.ios.pairedMacs"
    private let activeMacIDKey = "supercli.ios.activeMacID"
    private let deviceIDKey = "supercli.ios.deviceID"
