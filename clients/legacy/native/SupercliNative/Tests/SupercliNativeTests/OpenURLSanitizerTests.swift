...
final class OpenURLSanitizerTests: XCTestCase {
    ...
    func testDroppedPathsPreferProjectThenHomeRelativeText() {
        ...
        let project = "/Users/example/Dev/supercli"
        XCTAssertEqual(
            GhosttyTerminalPane.conciseDropReference(
                "/Users/example/Dev/supercli/clients/native/App.swift",
                projectRoot: project,
                homeDirectory: home
            ),
        ...
        XCTAssertEqual(
            GhosttyTerminalPane.conciseDropReference(
                "/Users/example/Dev/supercli-other/file.txt",
                projectRoot: project,
                homeDirectory: home
            ),
            "~/Dev/supercli-other/file.txt"
        )
    }
    ...
    func testDroppedImagesKeepAbsolutePathsForAgentAttachments() {
        ...
        let concise = GhosttyTerminalPane.conciseDropReference(
            image,
            projectRoot: "/Users/example/Dev/supercli",
