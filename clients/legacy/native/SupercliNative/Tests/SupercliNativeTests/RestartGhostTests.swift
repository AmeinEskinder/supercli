...
/// Tests for `SupercliStore.supersededRestartGhostIDs` — the rescan pass that
...
final class RestartGhostTests: XCTestCase {
    private typealias Candidate = SupercliStore.RestartGhostCandidate
    ...
    func testExitedTwinWithLiveReplacementIsGhost() {
        ...
        let ghosts = SupercliStore.supersededRestartGhostIDs([
    ...
    func testMultipleRestartPairsEachResolveIndependently() {
        ...
        let ghosts = SupercliStore.supersededRestartGhostIDs([
            Candidate(id: "codex-old", projectID: "supercli", createdAt: 1783511375479, isLive: false),
            Candidate(id: "codex-new", projectID: "supercli", createdAt: 1783511375479, isLive: true),
            Candidate(id: "claude-old", projectID: "supercli", createdAt: 1783502687475, isLive: false),
            Candidate(id: "claude-new", projectID: "supercli", createdAt: 1783502687475, isLive: true),
            // An unrelated live session must be untouched.
            Candidate(id: "bystander", projectID: "supercli", createdAt: 1783500000000, isLive: true),
        ])
