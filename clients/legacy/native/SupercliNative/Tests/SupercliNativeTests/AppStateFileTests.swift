...
final class AppStateFileTests: XCTestCase {
    ...
    func testSidebarInactivePreviewDefaultsToFive() throws {
        ...
        XCTAssertEqual(SupercliStore.resolvedSidebarStoppedLimit(state), 5)
        XCTAssertEqual(SupercliStore.resolvedSidebarStoppedLimit(nil), 5)
        XCTAssertEqual(SupercliStore.resolvedSidebarStoppedLimit(invalid), 5)
        XCTAssertEqual(SupercliStore.resolvedSidebarStoppedLimit(
    ...
    func testDecodesAppOpenApprovalsAndSemanticPresentations() throws {
        ...
        XCTAssertEqual(state.mcpAppOpenApprovals["caller-1"], ["supercli.app.design"])
