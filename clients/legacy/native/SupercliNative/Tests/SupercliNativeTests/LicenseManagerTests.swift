...
final class LicenseManagerTests: XCTestCase {
    ...
    func testLicenseConfigUsesDevEnvironmentOverrides() {
        let environment = [
            "SUPERCLI_LICENSE_PUBLIC_KEY": "dev-public-key",
            "SUPERCLI_LICENSE_API_BASE_URL": "http://localhost:5173"
        ]
    ...
    func testSeatLimitMessageUsesPurchasedSeatCountWhenPresent() {
        XCTAssertEqual(
            ...
            "All 2 seats for this license are in use. Deactivate Supercli on another Mac first, or contact support."
        )
    }
    ...
    func testSeatLimitMessageAvoidsOldThreeMacFallback() {
        XCTAssertEqual(
            ...
            "All purchased seats for this license are in use. Deactivate Supercli on another Mac first, or contact support."
        )
    }
