...
struct ContentArea: View {
    ...
    /// explicitly invoked (the Finder "New Supercli Session Here" service sets
...
/// conversation storage no longer exists on disk (SupercliStore.resumeFailures)
...
/// The Supercli pixel mascot — the same 13×13 frames the iOS app bundles
/// (`MascotFrame0…3`, extracted losslessly from
/// `supercli-mascot/mascot-animated.webp`), reused as the empty-state face.
...
/// The Supercli "U" mark (apps/website/components/Logo.tsx): two halves on a shared
