...
//  UserDefaults next to supercli.sidebar.width.
//
...
struct RootView: View {
    ...
    @AppStorage("supercli.sidebar.width") private var savedSidebarWidth: Double = Double(Theme.sidebarDefaultWidth)
    ...
    /// keep their width.
    @AppStorage("supercli.projectSidebar.width") private var sharedProjectSidebarWidth: Double = Double(Theme.sidebarDefaultWidth)
    ...
    private static let projectSidebarWidthsKey = "supercli.projectSidebar.widths"
    ...
    var body: some View {
        ...
        // prewarm window retain duplicate supercli-attach children indefinitely.
