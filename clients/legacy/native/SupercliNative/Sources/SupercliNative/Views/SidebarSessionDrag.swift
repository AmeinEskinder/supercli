...
final class SidebarSessionDragController: ObservableObject {
    ...
    private(set) weak var store: SupercliStore?
    ...
    func bind(store: SupercliStore, dragState: SidebarDragState, monitorView: NSView?) {
        self.store = store
    ...
    private func updatePanelReorder() {
        ...
        store.setProjectSidebarInsertPreview(target.map {
            SupercliStore.ProjectSidebarInsertPreview(
    ...
    private func releaseDraggedPaneToSidebar(store: SupercliStore) {
