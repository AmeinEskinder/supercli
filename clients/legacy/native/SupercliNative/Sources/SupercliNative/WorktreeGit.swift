...
//  ~/.supercli/worktrees/<repo-name>-<repo-hash>/<worktree-name-slug> so
...
enum WorktreeGit {
    ...
    /// ~/.supercli/worktrees, canonicalized like canonical_or_self —
    ...
    static func worktreesRoot() -> URL {
        LaunchConfig.supercliDir.appendingPathComponent("worktrees")
    }
