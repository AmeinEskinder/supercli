...
impl WorkspaceOpenTarget {
    ...
    pub fn title(&self) -> &'static str {
        match self {
            ...
            WorkspaceOpenTarget::Xcode => "Xcode",
        }
    }
                ...
                ul { class: "worktree-list",
                    for w in worktrees {
                        li {
                            ...
                            if w.is_dirty { span { class: "worktree-dirty", "uncommitted changes" } }
