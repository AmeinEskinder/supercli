...
impl TermColor {
    ...
    /// CSS color value. `None` means {t("terminal.inherit_terminal_default")}.
...
/// The {t("terminal.copy_all")} text: like [`viewport_text`] but with trailing padding
    ...
    rsx! {
        div { class: "text-selection-sheet",
            div { class: "text-selection-bar",
                span { class: "text-selection-title", {t("terminal.select_text")} }
                button {
