    ...
    rsx! {
        div { class: "gallery-panel", "data-testid": "gallery-panel",
            div { class: "gallery-toolbar",
                span { class: "gallery-title", "data-testid": "gallery-title", "Browser Gallery" }
                div { class: "annotation-spacer" }
                button {
                    "data-testid": "gallery-screenshot",
                    onclick: move |_| on_screenshot.call(()),
                    title: "Ask the Host to capture a screenshot into this gallery",
                    "Screenshot"
                }
                button { "data-testid": "gallery-upload", onclick: move |_| on_upload.call(()), "Upload" }
                button { "data-testid": "gallery-refresh", onclick: move |_| on_refresh.call(()), "Refresh" }
            }
            if loading {
...
pub fn GalleryDetailView(
    ...
    rsx! {
        div { class: "gallery-detail",
            div { class: "gallery-toolbar",
                button { onclick: move |_| on_close.call(()), "‹ Gallery" }
            ...
            if let Some(mode) = editor {
                ...
                if entry.is_image() {
                    div { class: "gallery-actions",
                        button { "data-testid": "gallery-annotate-arrows", onclick: move |_| on_editor.call(Some(AnnotationMode::Arrows)), "Arrows" }
                        button { "data-testid": "gallery-annotate-draw", onclick: move |_| on_editor.call(Some(AnnotationMode::Freehand)), "Draw" }
                        button { "data-testid": "gallery-annotate-crop", onclick: move |_| on_editor.call(Some(AnnotationMode::Crop)), "Crop" }
                    }
                }
