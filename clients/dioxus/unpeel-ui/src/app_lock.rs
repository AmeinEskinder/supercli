...
impl fmt::Display for AuthError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            AuthError::Unavailable => write!(f, "Biometric unlock is not available in this build"),
            AuthError::UserCancel => write!(f, "Authentication was cancelled"),
            AuthError::SystemCancel => write!(f, "Authentication was interrupted"),
...
pub fn method_label(capability: &AppLockCapability) -> &'static str {
    ...
    fn authenticate(&self, reason: &str) -> Result<(), AuthError> {
        #[cfg(feature = "shell-biometric")]
        {
            ...
            return match code {
                ...
                _ => Err(AuthError::Failed("Authentication failed".to_string())),
            };
        }
        #[cfg(not(feature = "shell-biometric"))]
        {
...
impl AppLockManager {
    ...
    pub fn unlock(&mut self) -> bool {
        ...
        if self.authenticate("Unlock Unpeel") {
            self.is_locked = false;
            true
        } else {
            false
    ...
    rsx! {
        div { class: "app-lock-overlay",
            div { class: "app-lock-card",
                ...
                div { class: "app-lock-title", "Unpeel is locked" }
