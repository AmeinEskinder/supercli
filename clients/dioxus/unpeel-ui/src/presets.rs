//! Preset drawer: the "New session" bottom sheet.
//!
...
/// "New session" bottom sheet. `presets` must already be filtered to the
...
/// case the header shows just "New session".
#[component]
pub fn PresetDrawer(
            ...
            div {
                ...
                div {
                    ...
                    div { class: "preset-drawer-titles",
                        div { class: "preset-drawer-title", "New session" }
