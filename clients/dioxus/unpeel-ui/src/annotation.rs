    ...
    rsx! {
        div { class: "annotation-editor",
            div { class: "annotation-toolbar",
                button { onclick: move |_| on_cancel.call(()), {t("annotation.cancel")} }
            ...
            div { class: "annotation-palette",
                for swatch in PALETTE {
                    button {
                        class: if *color.read() == swatch { {t("annotation.swatch_selected")} } else { "swatch" },
                        style: "background: {swatch}",
                        aria_label: {t("annotation.color")},
