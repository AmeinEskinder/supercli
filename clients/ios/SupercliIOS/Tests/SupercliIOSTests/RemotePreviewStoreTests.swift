...
final class RemotePreviewStoreTests: XCTestCase {
    ...
    func testSessionCreationCapabilityKeepsLegacyPermissiveAndRequiresAdvertisedOperation() {
        ...
        legacy.showPresetDrawer(for: "project-supercli")
        XCTAssertEqual(legacy.presetDrawerProjectID, "project-supercli")
        ...
        omitted.showPresetDrawer(for: "project-supercli")
    ...
    func testResumeAgentRequiresReturnedShellAndBothCapabilities() async {
        func session(
            ...
            RemoteSessionSummary(
                id: "live", projectID: "project-supercli",
    ...
    func testLegacyRestartIsStoppedResumeOnly() async {
        let live = RemoteSessionSummary(
            id: "live", projectID: "project-supercli", providerID: "claude",
            title: "Claude", command: "claude", createdAtUnixMs: 1,
            status: .running, activity: .idle,
            capabilities: RemoteSessionCapabilities(
                restart: true,
    ...
    func testCreateWithoutSummaryPollsBootstrapUntilSessionIsSelectableWithoutRetryingMutation() async throws {
        ...
        XCTAssertEqual(
            createRequests,
            [RemoteCreateSessionRequest(projectID: "project-supercli", presetID: "preset-codex")]
        )
        ...
        XCTAssertTrue(store.expandedProjectIDs.contains("project-supercli"))
    ...
    func testSidebarTreeNestsGroupsAndWorktreesUnderTheirProject() throws {
        let snapshot = RemoteBootstrapSnapshot(
            ...
            projects: [
                ...
                .init(id: "project-supercli", name: "Supercli", path: "/dev/supercli", sortOrder: 2),
                .init(
                    id: "group-research",
                    name: "Research",
                    path: "/dev/supercli",
        ...
        XCTAssertEqual(tree.looseProjects.map(\.id), ["project-supercli"])
        ...
        let root = try XCTUnwrap(snapshot.projects.first { $0.id == "project-supercli" })
        XCTAssertEqual(
    ...
    func testInitialSelectionInWorktreeExpandsParentAndChild() {
        let snapshot = RemoteBootstrapSnapshot(
            ...
            folders: [],
            projects: [
                .init(id: "project-supercli", name: "Supercli", path: "/dev/supercli", sortOrder: 0),
                .init(
                    id: "worktree-native-b",
                    name: "native-b",
                    path: "/tmp/native-b",
    ...
    func testColdLaunchRestoresLastSessionAndRevealsItsProject() async {
        ...
        XCTAssertTrue(
            store.expandedProjectIDs.contains("project-supercli"),
    ...
    private func freshDefaults(_ name: String = #function) -> UserDefaults {
        let suiteName = "supercli.tests.\(name).\(UUID().uuidString)"
    ...
    private func replacementSession(
        id: String,
        projectID: String = "project-supercli",
