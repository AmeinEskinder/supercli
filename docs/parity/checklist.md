...
| 169 | [DESKTOP] | libghostty Metal terminal surfaces, retained per session | partial | clients/supercli-app/lib/terminal/terminal_pane.dart + terminal_state.dart + terminal_types.dart (real impl 2385779; RLE fallback until gpuidart ships P0-8 UiTerminal — see docs/gpuidart-gaps.md G-1..G-11) | clients/supercli-app/test/terminal_pane_test.dart (34 behavior tests) |
...
| 186 | [DESKTOP] | In-pane MCP approval overlay (write/browser/app-open) | done | clients/supercli-app/lib/app.dart (de51bb2) | clients/supercli-app/test/app_test.dart ('approval card appears when an approval is pending'); screenshots docs/internal/proofs/proof-screenshots/approve-{before,after}.png, deny-{before,after}.png |
